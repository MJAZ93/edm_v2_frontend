...
**data_execucao** | **string** | YYYY-MM-DD format | [optional] [default to undefined]
...
```typescript
import { InstalacaoAccoesUpdateInstalacaoAccoesRequest } from './api';

const instance: InstalacaoAccoesUpdateInstalacaoAccoesRequest = {
    accao_tipo_id,
    analise_status,
    comentario,
    data_execucao,
